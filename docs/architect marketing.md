...
**“Signage & Wayfinding: A Design-Led Approach for Architects”**
...
• Early input on signage strategy and placement

• Advice on materials, finishes and fixing methods

• Planning-ready visuals and proportions

• Technical detailing at RIBA Stages 4–5

• Build-ready packages contractors can deliver accurately

• Close coordination through fabrication and installation

The goal is simple: what’s designed is what gets built.
...
Complex public-facing environment requiring clear wayfinding without visual clutter, delivered within a sensitive architectural setting.
...
• Sit quietly within the architecture

• Respect material language and proportions

• Support intuitive movement without over-signage

The architectural intent was minimal, legible and integrated.

---

**Technical Resolution**

Working alongside the design team, we:

• Developed material-appropriate signage details

• Resolved fixing methods that protected surrounding finishes

• Coordinated with façade, interior and MEP packages

• Produced technical drawings aligned with the architectural set

All details were agreed before procurement.

---

**Delivery**

• Fabrication followed the approved architectural details

• Installation aligned with site sequencing

• No design compromise during value-engineering

• Final installation matched the original intent

The result was signage that felt considered, purposeful and part of the architecture — not applied to it.
...
**3️⃣ MATERIALS & DETAIL REFERENCE SHEET**

**Architectural Signage: Materials & Fixing Principles**
...
Selected based on context, durability and visual restraint:
...
All materials are selected to age appropriately and perform long-term.

---

**Fixing Principles**

Resolved to protect the architecture:
...
Fixings are designed as part of the detail — not an afterthought.
...
* **The email** opens the conversation  
* **The one-pager** positions you as design-led  
* **The case study** proves delivery  
* **The reference sheet** makes you useful

This is exactly the kind of material architects **keep**, **share**, and **remember**.
