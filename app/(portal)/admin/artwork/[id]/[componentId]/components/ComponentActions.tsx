                ...
                {isEditing ? (
                    <div className="flex items-center gap-1.5">
                        <input
                            ...
                            className="text-xl font-bold text-neutral-900 tracking-tight bg-transparent border-b-2 border-neutral-300 focus:border-[#4e7e8c] outline-none py-0.5 min-w-[200px]"
                            disabled={isPending}
                        />
                        <button
