                                        ...
                                        <td className="px-4 py-3">
                                            <div className="flex items-center gap-2">
                                                ...
                                                <select
                                                    ...
                                                    className="flex-1 min-w-0 px-3 py-1.5 text-sm border border-neutral-200 rounded-[var(--radius-sm)] focus:outline-none focus:ring-2 focus:ring-[#4e7e8c] bg-white"
                                                >
                                                    <option value="">
                                                        -- no default --
                                                    </option>
