...
export function QuoteHeaderEdit({ quote }: QuoteHeaderEditProps) {
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 p-4 bg-neutral-50 rounded-[var(--radius-sm)] border border-neutral-200 mb-6">
                ...
                <div>
                    ...
                    <textarea
                        ...
                        rows={3}
                        className="w-full px-3 py-2 text-sm border border-neutral-200 rounded focus:outline-none focus:ring-2 focus:ring-black"
                        placeholder="Internal notes (not visible on PDF)..."
                    />
                </div>
                ...
                <div className="flex justify-end gap-3 pt-2">
                    ...
                    <button
                        type="submit"
                        disabled={isSaving}
                        className="flex items-center gap-2 px-3 py-1.5 text-xs font-medium bg-black text-white rounded hover:bg-neutral-800 disabled:opacity-50"
                    >
    ...
    return (
        <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-neutral-600 bg-neutral-100 hover:bg-neutral-200 rounded-[var(--radius-sm)] transition-colors"
        >
            <Edit2 size={12} />
            Edit Details
        </button>
