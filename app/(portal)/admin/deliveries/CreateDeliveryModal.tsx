                    ...
                    <>
                        ...
                        <div className="flex justify-end gap-2 pt-2">
                            ...
                            <button
                                ...
                                className="flex items-center gap-2 px-4 py-2 text-sm font-medium bg-[var(--accent)] text-white rounded-[var(--radius-sm)] hover:bg-[var(--accent-hover)] disabled:opacity-50 disabled:cursor-not-allowed"
                            >
