...
import { RouteLayer, getRouteColour, type ActiveRoute } from './components/RouteLayer';
...
export function MapPanel({ pins }: Props) {
    ...
    if (!MAPBOX_TOKEN) {
        return (
            <div className="h-full bg-neutral-100 rounded-lg flex items-center justify-center text-neutral-500 text-sm">
    ...
    return (
        <div className="h-full flex flex-col">
            ...
            {/* Map */}
            <div className="rounded-lg overflow-hidden border border-neutral-200 relative flex-1" style={{ height: '100%' }}>
                {isTilted && (
                    <button
                        onClick={resetView}
