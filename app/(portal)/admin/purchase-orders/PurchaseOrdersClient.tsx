        ...
        <div className="p-6 max-w-6xl mx-auto">
            ...
            <div className="flex items-center justify-between mb-6">
                ...
                <button
                    ...
                    className="flex items-center gap-2 px-4 py-2 text-sm font-medium bg-[#4e7e8c] text-white rounded-[var(--radius-sm)] hover:bg-[#3a5f6a]"
                >
                    <Plus size={16} />
                    New PO
                </button>
            ...
            <div className="flex flex-col sm:flex-row gap-3 mb-4">
                ...
                <div className="relative sm:ml-auto">
                    ...
                    <input
                        ...
                        className="pl-8 pr-3 py-1.5 text-sm border border-neutral-200 rounded-[var(--radius-sm)] w-64 focus:outline-none focus:ring-2 focus:ring-[#4e7e8c]"
                    />
                </div>
            </div>
                ...
                <form onSubmit={handleSubmit} className="p-5 space-y-4">
                    {orgs.length > 1 && (
                        <div>
                            ...
                            <select
                                ...
                                className="w-full px-3 py-2 text-sm border border-neutral-200 rounded focus:outline-none focus:ring-2 focus:ring-[#4e7e8c]"
                            >
                    ...
                    <div className="flex justify-end gap-3 pt-2">
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 px-4 py-1.5 text-xs font-medium bg-[#4e7e8c] text-white rounded hover:bg-[#3a5f6a] disabled:opacity-50"
                        >
