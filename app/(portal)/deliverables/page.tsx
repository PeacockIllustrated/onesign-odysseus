            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
                <div className="relative">
                    <select
                        ...
                        className="appearance-none bg-white border border-neutral-200 rounded-[var(--radius-sm)] px-4 py-2 pr-10 text-sm font-medium text-neutral-900 focus:outline-none focus:ring-2 focus:ring-[#4e7e8c] cursor-pointer"
                    >
                        {monthOptions.map((m) => (
                        ...
                        <div className="border-t border-neutral-200 pt-4 mt-4">
                            ...
                            <div className="flex gap-2">
                                <input
                                    ...
                                    className="flex-1 px-3 py-2 border border-neutral-200 rounded-[var(--radius-sm)] text-sm focus:outline-none focus:ring-2 focus:ring-[#4e7e8c]"
