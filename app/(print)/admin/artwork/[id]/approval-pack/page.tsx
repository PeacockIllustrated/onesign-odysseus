 ...
 *
 * Follows the existing (print)/ pattern: no <html>/<body>, just a
 * root <div> + <style> block. Ctrl+P → Save as PDF.
 */
export default async function ApprovalPackPage({
    ...
    return (
        <div className="approval-pack-root">
            ...
            {/* Print hint */}
            <div className="no-print" style={{ marginBottom: 24, fontSize: 12, color: '#999' }}>
                Ctrl+P → Save as PDF
            </div>
            ...
            {chosenPerComponent.map((item, i) => (
                ...
                >
                    ...
                    <h2 style={{ fontSize: 18, fontWeight: 700, marginBottom: 12, marginTop: 0 }}>
                        {item.componentName}
                    </h2>
            ...
            {approval.client_comments && (
                <div style={{
                    ...
                    <p style={{ fontSize: 13, color: '#6b5900', whiteSpace: 'pre-wrap', lineHeight: 1.6, margin: 0 }}>
                        {approval.client_comments}
                    </p>
                </div>
            )}
