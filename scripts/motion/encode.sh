...
#
#   scripts/motion/encode.sh out/bloom-mobile-master.mp4 out/bloom-mobile.mp4 2600k   # web: stays under 15 MB for a ~40s piece
#   scripts/motion/encode.sh out/bloom-mobile-master.mp4 out/bloom-mobile-6mbps.mp4 6M # share: for sending on / socials
#
