...
//
//   node <skill>/scripts/stills.mjs story.html --at 10.5,11.0,11.2,11.4 --out out/beat.png
//   node <skill>/scripts/stills.mjs story.html --at 29.6,30,30.3 --portrait --out out/beat-p.png
//
...
// Options: --style <name>  --query 'a=1&b=2'  --cols 3  --tile-width 640  --portrait  --real  --keep (also keep each frame as its own PNG)
