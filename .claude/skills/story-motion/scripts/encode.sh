...
#
#   <skill>/scripts/encode.sh out/story-mobile-master.mp4 out/story-mobile.mp4 2600k   # web: stays under 15 MB for a ~40s piece
#   <skill>/scripts/encode.sh out/story-mobile-master.mp4 out/story-mobile-6mbps.mp4 6M # share: for sending on / socials
#
